    ...
    <div class="center-content">
        <div class="container">
            ...
            <div class="white-container">
                            ...
                            <#list followers as user1>
                                <li ng-repeat="user in ctrl.users" class="list-item">
                                    <div class="light_blue text1">
                                        ...
                                        <div class="light_blue text">
                                            <a class="hov" href="/user-profile?id=${user1.id}"> ${user1.firstName} ${user1.lastName}</a>
                                        </div>
                                    </div>
                ...
                <#else>
                    <div class="light_blue text">Нет подписок</div>
                </#if>
            </div>
        </div>
    </div>
